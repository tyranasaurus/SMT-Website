...
<br /><br />
<Heading
  text="Stanford Math Tournament 2023 Online"
  size={4}
  ...
  <PanelBox>
    <div style="padding: 10px;">
      <p>
        ...
        <strong>TEAM SIZE:</strong> 6-8 (smaller teams may be combined with
        others to make full teams) <br />
        <strong>COST:</strong> $10 early bird registration per student, $15
        regular registration, $25 last-minute registration (Financial Aid
...
<div class="section-wrapper">
  <PanelBox>
    <div style="padding: 10px;">
      <p>
        In order to properly register for SMT Online, all of the following steps
        must be completed by the coach and students:
      </p>
      <ol>
        <li>
          Coaches must make payment for participating students on <a
            href="https://tinyurl.com/SMT2023OnlineEventbrite">Eventbrite</a
          >. Seats purchased on Eventbrite will be reflected in ContestDojo
          within two business days.
        </li>
        <li>
          Coaches must create a coaches account <a
            href="https://contestdojo.com">ContestDojo</a
          > and register thir organization for SMT 2023 Online.
        </li>
        <li>
          Coaches must invite students on ContestDojo by email or organization
          join code.
        </li>
        <li>
          Students must join the organization and fill out the registration
          form.
        </li>
...
<Timeline width="60%">
  ...
  <TimelineElement>
    <strong>March 15, 2023 at 11:59 PM PT:</strong> Early Bird ($10/student) registration
    deadline
  </TimelineElement>
  <TimelineElement>
