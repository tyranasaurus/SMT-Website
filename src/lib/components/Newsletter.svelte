<script>
	...
	async function setAction() {
		...
		if (
			...
			await fetch(
				'https://stanford.us14.list-manage.com/subscribe/post?u=491215d1bdd0bc030363b5dd3&amp;id=cc16fac9fb&amp;f_id=00b2a0e0f0',
				{
					body: formData,
					method: 'post',
					mode: 'no-cors',
	...
	<div class="surround">
		<div class="form">
			...
			<div id="mc_embed_signup">
				...
				<button style="position: absolute; top: 10px; right: 10px; border: none; background-color: transparent;"
						on:click={() => {
							show = !show
							user.update((u) => (u = false))
						}}>
					...
					<div id="mc_embed_signup_scroll">
						<div>
							...
							<p style="margin: 0; padding:0;">
								Sign up for our mailing list for date
						...
						<div class="mc-field-group">
							<label for="mce-undefined"
								>Student Grade (2024-25) <span class="asterisk"
									>*</span
								></label
							>
							<select
						...
						<div class="mc-field-group">
							...
							>
								...
								<option value="Other U.S. Territory"
									>Other U.S. Territory</option
								>
								<option value="Not in the U.S."
									>Not in the U.S.</option
								>
							</select>
							<span
								id="mce-STATE-HELPERTEXT"
								class="helper_text"
							/>
						</div>
						<div class="mc-field-group">
