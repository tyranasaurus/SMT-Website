...
<div style="margin-left: 10vw; margin-right: 10vw;">
  <PanelBox>
    ...
    <br />
    <p style="font-size: 1.5em; text-align: center;">
      These classes will be run year-round and will be split into 4 main topics:
      Algebra, Combinatorics, Number Theory, and Geometry, each run for <strong
        >8 weeks</strong
      >. Instructive sessions will run for
      <strong>90 minutes</strong>
      every week over Zoom. Additionally, teachers will hold
      <strong>office hours</strong>
      each week, during which students can seek assistance with the content or ask
      any lingering questions. Each class will have
      <strong>10-15 students</strong>
      and, depending on the interest we receive, there may be multiple classes run
      for each level. The total cost for 8 weeks of classes will be
...
<div style="margin-left: 10vw; margin-right: 10vw;">
  <PanelBox>
    <p style="font-size: 1.5em; text-align: center;">
      ...
      >
      and run through till <strong>March 5th, 2023</strong>. There are currently
      2 levels of classes planned,
      <strong>Beginner Geometry (AMC 8 level)</strong>
      and <strong>Intermediate Geometry (AMC 10/12 level)</strong>. See below
      for the weekly schedule and breakdown of topics! If you're interested in
...
<div style="margin-left: 10vw; margin-right: 10vw;">
  <PanelBox>
    <p style="font-size: 1.5em; text-align: center;">
      The total cost for the 8 sessions of Geometry will be <strong>$80</strong
      >.
    </p>
    <p style="font-size: 1.5em; text-align: center;">
...
<div style="margin-left: 10vw; margin-right: 10vw;">
  <PanelBox>
    <p style="font-size: 1.5em; text-align: center;">
      ...
      specifically towards the student's needs. Pricing is flexible depending on
      level of instruction required, and will be generally more than our group
      classes. Do note that instructor availability may be limited. If you are
      interested in one-on-one tutoring, email us at <a
        target="_blank"
