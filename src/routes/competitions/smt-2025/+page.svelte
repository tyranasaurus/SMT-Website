<script>
    ...
    const scheduleData = [
        ...
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Monday, 4/8", "PotD #1", "PotD #1", "PotD #1", "N/A"],
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Tuesday, 4/9", "PotD #2", "PotD #2", "PotD #2", "N/A"],
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Wednesday, 4/10", "PotD #3", "PotD #3", "PotD #3", "N/A"],
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Thursday, 4/11", "PotD #4", "PotD #4", "PotD #4", "N/A"],
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Friday, 4/12", "PotD #5", "PotD #5", "PotD #5", "N/A"],
        ["<font style='font-size: 150%'>Friday Fun Functions [ƒ<sup>3</sup>]</font><br>4/11<br><i style='font-size: 80%'>Optional Social<br>Events</i>", "3:30 PM", "Early Check-In", "Early Check-In", "Early Check-In", "Early Check-In"],
        ["<font style='font-size: 150%'>Friday Fun Functions [ƒ<sup>3</sup>]</font><br>4/11<br><i style='font-size: 80%'>Optional Social<br>Events</i>", "4:30 PM", "Are You Smarter Than an SMT Organizer?", "Puzzle Hunt", "Stanford Tours", "Stanford Tours"],
        ["<font style='font-size: 150%'>Friday Fun Functions [ƒ<sup>3</sup>]</font><br>4/11<br><i style='font-size: 80%'>Optional Social<br>Events</i>", "6:00 PM", "Origami Relay", "Puzzle Hunt", "Math Games", "Math Games"],
        ["<font style='font-size: 150%'>Friday Fun Functions [ƒ<sup>3</sup>]</font><br>4/11<br><i style='font-size: 80%'>Optional Social<br>Events</i>", "7:30 PM", "Dinner", "Dinner", "Dinner", "Dinner"],
        ["<font style='font-size: 150%'>Friday Fun Functions [ƒ<sup>3</sup>]</font><br>4/11<br><i style='font-size: 80%'>Optional Social<br>Events</i>", "8:00 PM", "Board Games", "Board Games", "Integration Bee Qualifiers", "Integration Bee Qualifiers"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "7:00 AM", "Check-In", "Check-In", "Check-In", "Check-In"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "8:00 AM", "Opening Ceremony", "Opening Ceremony", "Opening Ceremony", "Opening Ceremony"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "8:30 AM", "Power Round", "Power Round", "Power Round", "Unstructured Time"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "9:00 AM", "Power Round", "Power Round", "Power Round", "Student Panel"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "10:15 AM", "Team Round", "Team Round", "Team Round", "Student Panel"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "10:30 AM", "Team Round", "Team Round", "Team Round", "Unstructured Time"],       
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "11:15 AM", "Lunch Break", "Lunch Break", "Lunch Break", "Lunch Break"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "12:15 PM", "Subject Test #1", "Subject Test #1", "General Test", "Solve an SMT General Round!"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "1:15 PM", "Subject Test #2", "Subject Test #2", "General Test", "Solve an SMT General Round!"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "2:30 PM", "Guts Round", "Guts Round", "Guts Round", "Guts Scoreboard Livestream"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "4:00 PM", "Math Talk w/ Tadashi Tokieda", "Integration Bee Finals", "Estimathon", "Unstructured Time"],
        ["<font style='font-size: 150%'>Saturday Tournament</font><br>4/12<br><i style='font-size: 80%'>Tournament Day</i>", "5:30 PM", "Awards", "Awards", "Awards", "Awards"],
    ]
    ...
    const formLink =
        "https://link.stanfordmathtournament.com/apply";
</script>
...
<br><br>
<Heading text="Stanford Math Tournament 2025" size={4} textColor="var(--heading-color)"/>
...
<div class="section-wrapper">
    <PanelBox>
        <div style="padding: 10px;">
            <p>SMT 2025 will be inviting <b>800 students</b> (~130-160 teams) from around the United States to compete in-person at Stanford. We are <b>now accepting applications</b> for our in-person tournament from <b>schools, local mathematical organizations, and individuals</b> from the United States. Students who are unable to participate in-person are invited to register for our <a href="/competitions/smt-2025-online">online tournament</a>.</p>
                
            <h4>Schools</h4>
            <p>Students are highly encouraged to participate in SMT 2025 as part of their <b>school team</b>. Students whose school is sending a team to SMT must attend with their school. Homeschooled students are considered to be a part of their local public school. <i>Please note that we will only accept school teams with exactly 5 or 6 participants. If you have fewer than 5 members, consider applying as individuals.</i></p>
            <h4>Local Established Mathematical Organizations</h4>
            <p>Students who do not have the opportunity to participate in SMT as part of their school may participate as part of a <b>local established mathematical organization</b>, defined as organizations with students located in a 50 mile radius of its headquarters that (1) conduct mathematical enrichment activities beyond competition participation and (2) provide clear avenues for any student to get involved. <i>Please note that we will only accept teams with exactly 5 or 6 participants. If you have fewer than 5 members, consider applying as individuals.</i></p>
            <h4>Individuals</h4>
            <p>If your school is not sending a team to SMT 2025 in-person and you can't find or form a local organization to participate with, you may register as an <b>individual competitor</b>. Students who register as individuals will be placed in a team with 5 other individual competitors, based on geographic proximity. Individuals may have a lower chance of being accepted to compete in SMT than students participating as part of a school or organization.</p>
...
<Timeline width="60%">
    ...
    <TimelineElement>
        <strong>March 7, 2025:</strong> Announcement of teams selected for
        in-person competition
    </TimelineElement>
    <TimelineElement>
        <strong>March 14, 2025:</strong> Deadline for selected teams to register & confirm their spots
    </TimelineElement>
    <!--<TimelineElement>
