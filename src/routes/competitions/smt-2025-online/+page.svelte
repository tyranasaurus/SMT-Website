<script>
    ...
    const scheduleData = [
        ...
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Monday, 4/7", "PotD #1", "PotD #1", "PotD #1"],
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Tuesday, 4/8", "PotD #2", "PotD #2", "PotD #2"],
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Wednesday, 4/9", "PotD #3", "PotD #3", "PotD #3"],
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Thursday, 4/10", "PotD #4", "PotD #4", "PotD #4"],
        ["<font style='font-size: 150%'>Problem of the Day</font><br>4/7 - 4/11<br><i style='font-size: 80%'>Unique and challenging problems leading up to the tournament</i>", "Friday, 4/11", "PotD #5", "PotD #5", "PotD #5"],
        ["<font style='font-size: 150%'>Activities</font><br><i>4/12</i>", "10:00 AM", "Puzzle Hunt", "TBD", "TBD"],
        ["<font style='font-size: 150%'>Activities</font><br><i>4/12</i>", "11:30 AM", "Puzzle Hunt", "Estimathon", "Estimathon"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "8:00 AM", "Check-In", "Check-In", "Check-In"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "9:00 AM", "Opening Ceremony", "Opening Ceremony", "Opening Ceremony"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "9:30 AM", "Power Round", "Power Round", "Power Round"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "11:10 AM", "Team Round", "Team Round", "Team Round"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "12:00 PM", "Lunch Break", "Lunch Break", "Lunch Break"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "1:00 PM", "Subject Test #1", "Subject Test #1", "General Test"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "2:00 PM", "Subject Test #2", "Subject Test #2", "General Test"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "3:00 PM", "Break", "Break", "Break"],
        ["<font style='font-size: 150%'>Tournament Day</font><br><i>4/13</i>", "3:30 PM", "Guts Round", "Guts Round", "Guts Round"],
        ["<font style='font-size: 150%'>Awards Ceremony</font><br><i>4/20</i>", "5:00 PM", "Awards", "Awards", "Awards"],
    ]
...
<br><br>
<Heading text="Stanford Math Tournament 2025 Online" size={4} textColor="var(--heading-color)"/>
        ...
        <div style="padding: 10px;">
            <p>
                ...
                <strong>COST:</strong> $15-$25 per student** (see timeline below) <br /> <br />
                              *The team formation rules for our in-person tournament do not apply here. Any students in high school or below can register with any team, or as an individual!  <br />
...
<Timeline width="60%">
    ...
    <TimelineElement>
        <strong>April 6, 2025 at 11:59 PM PT:</strong> Late ($25/student) registration deadline.
    </TimelineElement>
    <TimelineElement>
        <strong>April 9, 2025 at 11:59 PM PT:</strong> Very Late ($30/student) registration deadline and deadline for adding students to teams and filling out waivers. Teams are frozen on COMP (our online test-taking software).
    </TimelineElement>
    <TimelineElement>
...
<div class="section-wrapper">
    <PanelBox>
        ...
        <p>
            During and after tournament day, SMT will look for patterns of suspicious behavior. If substantial evidence suggests that a participant may have cheated, they will be disqualified <strong>unless</strong> they can provide recording(s) that satisfy the following requirements:
        </p>
        <ul>
            <li>The participant's screen and hands are visible for the full period of the test. This applies to <strong>all</strong> test-taking sessions.</li>
            <li>Each round must be contained in <strong>one</strong> continuous recording. Separate rounds may have their own recordings.</li>
