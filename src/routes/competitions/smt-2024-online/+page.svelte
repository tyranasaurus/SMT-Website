<script>
    ...
    const registrationData = [
        ...
        ["3", "Add your students to the ContestDojo platform. The deadline to add students (by Email or Join Code) and have them input their information is <b>4/10/2024 at 11:59 PM PT. This is a hard deadline.</b>", "Students join their team's organization on ContestDojo by Email or join code.", "Use Join Code <b>Nr4g</b> to join the Individual organization. You will later be assigned to a team."],
